...
class Emojifier {
    ...
    static void getClassifications(Face face) {
        ...
        Log.d(LOG_TAG, "getClassifications: smilingProbability = " + face.getIsSmilingProbability());
        Log.d(LOG_TAG, "getClassifications: leftEyeOpenProbability = " + face.getIsLeftEyeOpenProbability());
        Log.d(LOG_TAG, "getClassifications: rightEyeOpenProbability = " + face.getIsRightEyeOpenProbability());
    }
}
