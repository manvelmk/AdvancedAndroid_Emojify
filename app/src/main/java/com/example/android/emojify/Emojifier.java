...
class Emojifier {
    ...
    private static final double EYE_OPEN_PROB_THRESHOLD = .8;
    ...
    private static void whichEmoji(Face face){
        ...
        boolean rightEyeClosed = face.getIsLeftEyeOpenProbability() < EYE_OPEN_PROB_THRESHOLD;
        ...
        Log.d(LOG_TAG, "whichEmoji: expression = " + emoji.name());
